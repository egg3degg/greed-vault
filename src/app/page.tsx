...
const INITIAL_TRIBUTES: TributeItem[] = [
  {
    id: "trib_seed_1",
    senderAddress: "HU3bsSLMoJRzREe2qakCgrFpXky6NH2xpa3AfQfh1MaG",
    amountSol: 0.5,
  ...
  {
    id: "trib_seed_2",
    senderAddress: "BGurj7B6HT34v7fTFMP5SN2sXe8oQCXeBrEp8za7ve8G",
    amountSol: 0.1,
  ...
  {
    id: "trib_seed_3",
    senderAddress: "BDFoHZgfvHNSQAcusv4n71SyCEjKBHc5k8y2PjU5no98",
    amountSol: 0.05,
